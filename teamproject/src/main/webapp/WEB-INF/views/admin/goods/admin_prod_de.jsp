...
<ul class="my_gnb">
        ...
        <form name="frm" method="post">
            <div class="order_list21">
							...
							<table border="0" cellspacing="0" cellpadding="0" width="100%" class="myP_Ttype1">
								...
								<thead>
									...
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;이미지${status.count}																
										...
										<img src="${contextPath}/download?productNum=${pro.productNum}&fileName=${item.fileName}&fileType=${item.fileType}" />
						...
						<button type="button" class="btn btn-outline-dark" onclick="location='admin_prodco.do'">수정하기</button>
						</div>
					</div>
			</form>	
        </main>
