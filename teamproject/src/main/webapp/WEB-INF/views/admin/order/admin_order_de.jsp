...
<ul class="my_gnb">
						<li class="depth1">
							<a class="depth1_b_m" href="${contextPath}/adminmain.do" >관리자 페이지</a>
								<ul>
									<li><a href="${contextPath}/adminmember.do">회원 관리</a></li>
									<li><a href="${contextPath}/adminorder.do">주문 관리</a></li>
									<li><a href="${contextPath}/adminprod.do">상품 관리</a></li>
									<li><a href="${contextPath}/adminreview.do">후기 관리</a></li>
