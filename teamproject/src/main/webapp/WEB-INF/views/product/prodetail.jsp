	...
	<div class="container">
		...
		<figure>
			<img width="360px" height="300px" 
				     src="${contextPath}/thumbnails.do?category=${goods.category}&fileName=${goods.originFileName}">
		</figure>
	</div>
	</div>
</div>
...
<div class="btn_area" role="group" aria-label="Basic outlined example">
	...
	<a class="buy" href="javascript:fn_order_each_goods('${goods.productNum }','${goods.productName }','${goods.productPrice}','${goods.originFileName}');">구매하기 </a>
...
<div class="container"> 
  ...
  <div class="content">
    <div class="content-dis">
       <img src="${contextPath}/thumbnails.do?category=${goods.category}&fileName=${goods.originFileName}" class="card-img-top" alt="벤큐 모니터" style="width:1075px; height:500px;">
	...
	<thead>
		...
		<c:forEach items="${list}" var="list">
			<c:choose>
				...
				<tr align="center">
					<td><c:out value="${list.r_no}"></c:out></td>
					<td>
					<a href="#"><c:out value="${list.r_star}"></c:out></a>
					
					</td>
					<td><c:out value="${list.r_content}"></c:out></td>
					<td><c:out value="${list.user_id}"></c:out></td>
					<td><c:out value="${list.r_regdate}"></c:out></td>
