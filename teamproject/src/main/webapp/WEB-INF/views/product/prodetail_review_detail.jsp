...
<head>
  ...
  <!--  <script></script>
	...
	function fn_order_each_goods(productNum,productName,productPrice,originFileName){
	...
	<div class="container">
		...
		<figure>
			<img width="360px" height="300px" 
				     src="${contextPath}/thumbnails.do?productNum=${goods.productNum}&originFileName=${goods.originFileName}">
		</figure>
	</div>
	</div>
</div>
			<div class="pd info_price" style="width:750px">
							...
							<div class="ct price_inner">
								...
								<div class="orderamount_real" style="margin-left:500px; margin-top:-35px">									
										수량선택
								<div>
								<select style="width: 60px;" id="productAmt" name="productAmt">
				      <option>1</option>
							<option>2</option>
							<option>3</option>
							<option>4</option>
							<option>5</option>
								...
								<div class="allprice_real" style="margin-left:500px; margin-top:-35px">									
										250,000<span class="unit">원</span>					
								</div>
...
<div class="btn-group" role="group" aria-label="Basic outlined example">
	<ul>
		<li><a class="buy" href="javascript:fn_order_each_goods('${goods.productNum }','${goods.productName }','${goods.productPrice}','${goods.originFileName}');">구매하기 </a></li>
			<li><a class="cart" href="javascript:add_cart('${goods.productNum}')">장바구니</a></li>
		</ul>
</div>
...
<div class="container">
  ...
  <div class="content">
    <div class="content-dis">
       <img src="${contextPath}/thumbnails.do?productNum=${goods.productNum}&originFileName=${goods.originFileName}" class="card-img-top" alt="벤큐 모니터" style="width:1075px; height:500px;">
       <div class="content-info">
       <h2>벤큐 모비우스 무결점 27인치 모니터!</h2>
	 		<p>더욱 좋아진 고화질 모니터와 함께 배틀그라운드, 피파온라인4, 리그 오브 레전드 등 고사양 게임을 렉없이 즐겨보세요!
    	...
    	<table class="n-table table-row">
							<tbody>
								...
								<tr class="n-same-row">
									<th scope="row">내용</th>
									<td>
										<textarea name="re_content" cols="100" rows="20" class="n-input" readonly>${re.re_content}</textarea>
									</td>
								</tr>
