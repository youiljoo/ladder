		...
		<div>
			<div class="col-12">
				...
				<div>
							...
							<c:forEach var="item" items="${goodsMap.logitech }">
		...
		<div class="category-block" style="padding-left: 10px; padding-right: 10px;">
			...
			<img class="link"  src="${contextPath}/resources/images/1px.gif"> 
				...
				<img width="235" height="220" 
				     src="${contextPath}/thumbnails.do?category=${item.category}&fileName=${item.originFileName}">
		...
		<div>
			<div class="col-12">
				...
				<div class="section-title">
					...
					<p>따끈따끈한 신상품을 만나보세요!</p>
				</div>
				<div class="row">
					<!-- Category list -->
					<div class="col-lg-3 offset-lg-0 col-md-5 offset-md-1 col-sm-6 col-6">
							<div class="header">
							<c:forEach var="item" items="${goodsMap.samsung }">
	   <c:set  var="goods_count" value="${goods_count+1 }" />
		<div class="bestproductwrap">
		<div class="category-block" style="padding-left: 10px; padding-right: 10px;">
			<a href="${contextPath}/goods/goodsDetail.do?productNum=${item.productNum }">
			</a> 
			<a href="http://localhost:8080/teamproject/mouse/detail">
				<img width="235" height="220" 
				     src="${contextPath}/thumbnails.do?category=${item.category}&fileName=${item.originFileName}">
				</a>
			<div class="title">${item.productName}</div>
