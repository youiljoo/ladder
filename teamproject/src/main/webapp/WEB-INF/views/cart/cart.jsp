        ...
        <div class="wrapper">
            ...
            <div class="cart__content">
			        ...
			        <c:otherwise>
				     ...
				     <c:set var="user_id" value="${myCartList[cnt.count-1].user_id}" />
                        <div class="item__body"> 
                            ...
                            <ul class="item__spec">
                           <li class="item__checkbox"><input type="checkbox" name="checked_goods"  checked value="${item.productNum }"></li>
                                <li class="item__name"> 
					<td class="goods_image">
					<a href="${contextPath}/prodetail.do?productNum=${item.productNum }">
						<img width="80" height ="80" src="${contextPath}/thumbnails.do?productNum=${item.productNum}&originFileName=${item.originFileName}"  />
					</a>
					</td> 
					    ...
					    <fmt:formatNumber  value="${ item.productPrice*cartproductAmt}" type="number" var="total_price" />
				         ${total_price}원
                                ...
                                <li class="item__button"> 
                                 <a href="javascript:fn_order_each_goods('${item.productNum }','${item.productName }','${item.productPrice}','${item.originFileName}');"> 
                ...
                <div class="cart__total">
                    ...
                    <p id="p_final_totalPrice">${totalGoodsPrice}원</p>
