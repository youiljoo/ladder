...
public class MypageServiceImpl implements MypageService {
	...
	public List<OrderVO> listMyOrderGoods(String user_id) throws Exception {
		return mypageDAO.selectMyOrderGoodsList(user_id);
	}
	...
	public List<Map<String, Object>> conList(SearchCriteriaVO scri) throws Exception{
		List<Map<String, Object>> conList=mypageDAO.conList(scri);
		System.out.println("서비스:"+conList);
		return conList;
	}
	...
	return mypageDAO.conListCnt(scri);
	}
