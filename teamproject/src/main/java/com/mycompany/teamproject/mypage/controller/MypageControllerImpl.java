...
public class MypageControllerImpl implements MypageController {
	...
	public ModelAndView mypageMain(HttpServletRequest request, HttpServletResponse response)  throws Exception {
		...
		List<OrderVO> myOrderList = mypageService.listMyOrderGoods(user_id);
	...
	public ModelAndView mypageas(HttpServletRequest request, HttpServletResponse response) throws Exception {
		String viewName = (String)request.getAttribute("viewName");
		ModelAndView mav = new ModelAndView();
		mav.setViewName(viewName);
		return mav;
	...
	@RequestMapping(value="/mypageas2.do" ,method = RequestMethod.GET)
	public ModelAndView mypageas2(SearchCriteriaVO scri, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ModelAndView mav = new ModelAndView("mypageas2");
		mav.addObject("", mypageList);
	...
	//마이페이지 내 후기 작성
		...
		public ResponseEntity pro_review_action(MultipartHttpServletRequest multipartRequest,HttpServletResponse response)throws Exception{
			...
			try {
				...
				message+="location.href='"+multipartRequest.getContextPath()+"/orderlist.do';";
				message+="</script>";
		...
		// 마이페이지 내 상담내역
			...
			public ModelAndView myConsulting(SearchCriteriaVO scri,
			        ...
			        int conListCnt = mypageService.conListCnt(scri);
			        ...
			        List<Map<String, Object>> list = mypageService.conList(scri);
